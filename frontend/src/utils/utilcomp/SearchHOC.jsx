...
const SearchHOC = () => {
  return (
    <>
      <div className="flex px-8   py-4  bg-white items-center justify-between relative">
        <CiSearch className="inline-block ml-3  bg-white absolute text-gray-400 w-5 h-5" />
        <input
          type="text"
          placeholder="Search"
        ...
        />
        <div className="flex justify-between gap-5 bg-white items-center">
