    ...
    <>
      <div className="w-full p-8">
        <div className="w-full flex flex-wrap gap-4">
          ...
          <CustomerCard name="Sri Akkaa" color="bg-yellow-600" project="Burj Khalifa" flat="B 305" />
          ...
          <CustomerCard name="Amitabh Bachan" color="bg-purple-600" project="Weeknd Towers" flat="C 905" />
          <CustomerCard name="Shiva Don" color="bg-teal-600" project="Trump Towers" flat="A 105" />
          <CustomerCard name="Mourya Model" color="bg-red-600" project="Sky Towers" flat="D 306" />
